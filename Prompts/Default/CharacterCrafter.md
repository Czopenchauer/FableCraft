...
#### Identity Example: in_development

This shows how to track active character development. Most characters have empty `in_development`—only populate when something is genuinely shifting.
```json
{
  "in_development": {
...
#### Relationship Example: developing

This shows how to track active relationship shifts. Most stable relationships have empty `developing`—only populate when something is genuinely in flux.
```json
{
  "developing": {
