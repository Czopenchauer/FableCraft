...
internal interface IPluginFactory
{
    ...
    /// </summary>
    Task AddPluginAsync<T>(IKernelBuilder kernel, GenerationContext context, CallerContext callerContext)
        where T : PluginBase;
    ...
    /// </summary>
    Task AddCharacterPluginAsync<T>(IKernelBuilder kernel, GenerationContext context, CallerContext callerContext, Guid characterId)
        where T : CharacterPluginBase;
}