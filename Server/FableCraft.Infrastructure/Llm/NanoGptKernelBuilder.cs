...
internal class NanoGptKernelBuilder : IKernelBuilder
{
    ...
    public NanoGptKernelBuilder(LlmPreset preset, ILoggerFactory loggerFactory, Serilog.ILogger logger)
    {
    ...
    public Microsoft.SemanticKernel.IKernelBuilder Create()
    {
        ...
        builder.Services.AddTransient<NanoGptRequestTransformer>();
