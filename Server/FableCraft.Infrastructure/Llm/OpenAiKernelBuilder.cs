...
internal class OpenAiKernelBuilder : IKernelBuilder
{
    ...
    public OpenAiKernelBuilder(LlmPreset preset, ILoggerFactory loggerFactory, Serilog.ILogger logger, IMessageDispatcher messageDispatcher)
    {
    ...
    private HttpClient CreateHttpClient()
    {
        ...
        var loggingHandler = new HttpLoggingHandler(_logger, _messageDispatcher) { InnerHandler = innerHandler };
