...
namespace FableCraft.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251206205052_AddCharacterDevelopmentAgent")]
    partial class AddCharacterDevelopmentAgent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FableCraft.Infrastructure.Persistence.Entities.Adventure.Adventure", b =>
                {
                    ...
                    b.Property<Guid?>("ComplexPresetId")
                        .HasColumnType("uuid");

                    b.Property<DateTimeOffset>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("FastPresetId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ComplexPresetId");

                    b.HasIndex("FastPresetId");
            ...
            modelBuilder.Entity("FableCraft.Infrastructure.Persistence.Entities.Adventure.Adventure", b =>
                {
                    b.HasOne("FableCraft.Infrastructure.Persistence.Entities.LlmPreset", "ComplexPreset")
                        .WithMany()
                        .HasForeignKey("ComplexPresetId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("FableCraft.Infrastructure.Persistence.Entities.LlmPreset", "FastPreset")
                        .WithMany()
                        .HasForeignKey("FastPresetId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ComplexPreset");

                    b.Navigation("FastPreset");
                });
