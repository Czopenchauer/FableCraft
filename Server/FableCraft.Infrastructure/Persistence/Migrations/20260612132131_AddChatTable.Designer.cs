...
namespace FableCraft.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260612132131_AddChatTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FableCraft.Infrastructure.Persistence.Entities.Adventure.CharacterSceneRewrite", b =>
                {
                    ...
                    b.Property<string>("GatheredContext")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FableCraft.Infrastructure.Persistence.Entities.Adventure.Dispatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("EstimatedTransit")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("FromCharacter")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ToCharacter")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("WhatArrives")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FableCraft.Infrastructure.Persistence.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FableCraft.Infrastructure.Persistence.Entities.ChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FableCraft.Infrastructure.Persistence.Entities.LorebookSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FableCraft.Infrastructure.Persistence.Entities.ChatMessage", b =>
                {
                    b.HasOne("FableCraft.Infrastructure.Persistence.Entities.ChatSession", "ChatSession")
                        .WithMany("Messages")
