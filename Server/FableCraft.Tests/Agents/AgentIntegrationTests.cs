...
//     #endregion
//
//     #region MainCharacterTrackerAgent Tests
//
//     [Test]
//     public async Task TrackerAgent_OutputMapsToTracker()
//     {
//         // Arrange
//         var agent = new MainCharacterTrackerAgent(_agentKernel, _dbContextFactory, _kernelBuilderFactory);
//         GenerationContext context = AgentTestData.CreateSampleNarrativeContext(_testAdventureId, _dbContext, _testPreset);
//
//         // Act
...
//
//         _logger.Information("MainCharacterTrackerAgent output successfully mapped to Tracker");
